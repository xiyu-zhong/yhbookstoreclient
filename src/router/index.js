...
const AddCategory = () =>
  import ("./../pages/Admin/Children/AddCategory");
const AdminGoods = () =>
  import ("./../pages/Admin/Children/AdminGoods");
const AdminCategory = () =>
  import ("./../pages/Admin/Children/AdminCategory");
const AdminUpdate = () =>
  import ("./../pages/Admin/Children/AdminUpdate");
const CategoryUpdate = () =>
  import ("./../pages/Admin/Children/CategoryUpdate");
const AdminUsers = () =>
  ...
  routes: [{
    ...
    },
    {
      ...
      children: [
        ...
        { path: "addcategorys", component: AddCategory },
        { path: "admingoods", component: AdminGoods },
        { path: "admincategorys", component: AdminCategory },
        { path: "adminupdate", component: AdminUpdate },
        { path: "categoryupdate", component: CategoryUpdate },
