<template>
  <div id="me">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home">欢迎来到玉华网上书店</router-link>
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <a class="nav-link" @click.prevent="goBack">去前台看看</a>
        </li>
        <li class="nav-item text-nowrap">
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu
              ...
              <el-submenu index="3">
                ...
                <el-menu-item-group>
                  <el-menu-item index="3-2" @click="goTo('/me/sales?state=0')">待发货</el-menu-item>
                  <el-menu-item index="3-3" @click="goTo('/me/sales?state=1')">待收货</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
            </el-menu>
          </div>
