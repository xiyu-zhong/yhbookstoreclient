          ...
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                :key="index"
                :command="currentCate = cate.cate_id"
...
export default {
  ...
  created() {
    this.currentCate = this.$route.params.id;
    this.activeIndex = Number(this.$route.params.pageNo) || 1;
    console.log("this.currentCate", this.currentCate);
    if (this.currentCate) {
      // 请求分类数据
