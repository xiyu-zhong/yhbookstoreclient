<template>
  <div id="admin">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home">玉华网上书店</router-link>
      <span class="nav_title">欢迎来到后台管理界面</span>
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <router-link class="nav-link" to="/home">去书店看看</router-link>
        </li>
        <li class="nav-item text-nowrap">
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu
              ...
              <el-menu-item index="1"  @click="goTo('/admin/admingoods')">
                ...
                <span slot="title">书籍信息</span>
              </el-menu-item>
              <el-menu-item index="2" @click="goTo('/admin/addgoods')">
                <i class="el-icon-edit"></i>
                <span slot="title">书籍上架</span>
              </el-menu-item>
              <el-menu-item index="2" @click="goTo('/admin/addcategorys')">
                <i class="el-icon-edit"></i>
                <span slot="title">添加分类</span>
              </el-menu-item>
              <el-menu-item index="3" @click="goTo('/admin/admincategorys')">
